...
COMMON_SRC = src/deck.c src/hand.c src/state.c src/game.c src/communication.c src/poker_protocol.c src/player.c src/card.c src/state_protocol.c src/lobby.c
